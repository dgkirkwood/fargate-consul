...
consul agent -retry-join=10.0.101.100 -config-dir /opt/consul/config -bind=$CONSUL_BIND_ADDRESS -advertise=10.0.101.110 &
...
consul connect envoy -sidecar-for payments